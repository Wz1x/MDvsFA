...
for epoch in tqdm(range(args.epoch, args.n_epochs), desc='epoch', position=1):
    ...
    for i, batch_data in enumerate(tqdm(train_dataloader, desc='batch', position=0, colour='green')):
        ...
        if batches_done % args.test_interval == 0:
            ...
            g1_F1_list.append(sum_g1_F1)
            g2_F1_list.append(sum_g2_F1)
            g_F1_list.append(sum_g_F1)

            g1_recall_list.append(sum_g1_recall)
            g2_recall_list.append(sum_g2_recall)
            g_recall_list.append(sum_g_recall)

            g1_prec_list.append(sum_g1_prec)
            g2_prec_list.append(sum_g2_prec)
            g_prec_list.append(sum_g_prec)
...
print('')
print("best epoch: %d, best F1: %.4f"%(best_epoch, best_val_F1))
plotloss(g1_F1_list,g1_recall_list,g1_prec_list,1)
plotloss(g2_F1_list,g2_recall_list,g2_prec_list,2)
plotloss(g_F1_list,g_recall_list,g_prec_list,3)
